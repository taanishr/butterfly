    ...
    auto FlexResolver::phaseB() -> void {
        ...
        for (uint64_t i = 0; i < node->children.size(); ++i) {
            ...
            SizeRequest childRequest {
                ...
                .borderTop = childAsPtr->shared.border.topWidth.value_or(childAsPtr->shared.border.width),
                .borderRight = childAsPtr->shared.border.rightWidth.value_or(childAsPtr->shared.border.width),
                .borderBottom = childAsPtr->shared.border.bottomWidth.value_or(childAsPtr->shared.border.width),
                .borderLeft = childAsPtr->shared.border.leftWidth.value_or(childAsPtr->shared.border.width),
        ...
        for (auto& line : flex.lines) {
            ...
            for (auto& item : line.items) {
                ...
                SizeRequest childRequest {
                    ...
                    .borderTop = childNode->shared.border.topWidth.value_or(childNode->shared.border.width),
                    .borderRight = childNode->shared.border.rightWidth.value_or(childNode->shared.border.width),
                    .borderBottom = childNode->shared.border.bottomWidth.value_or(childNode->shared.border.width),
                    .borderLeft = childNode->shared.border.leftWidth.value_or(childNode->shared.border.width),
