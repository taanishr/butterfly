...
namespace elements {
    ...
    struct ImageProcessor {
        ...
        template <LayoutStateType L>
        Finalized<U> finalize(Fragment<S>& fragment, Constraints& constraints, SharedDescriptor& shared, ImageDescriptor& desc, Atomized& atomized, L& layout, const SizeResult& sizeResult, Placed& placed) {
