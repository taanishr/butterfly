...
- Hover, active/pressed, and focus-visible states.
- Tab navigation and focus trapping.
- Keyboard shortcut normalization.

### 6. Transitions / animations

- Transform transitions and animations first.
...
- Deferred: tooltips, popovers, modals, and context menus.
- Anchored placement that stays within available space and follows scrolling.

### 7a. Caching rethink

- Reuse unchanged layout results across frames.
- Recompute only layout affected by a change.
- Bounded cache memory without frame hitches.
- Revisit before size animation.
