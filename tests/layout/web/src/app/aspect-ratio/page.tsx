export default function AspectRatioPage() {
  ...
  return (
    <>
      ...
      <main style={{ width: "100vw", height: "100vh", padding: 24, overflow: "auto", background: "rgb(14,17,22)", color: "white", fontFamily: "Arial, sans-serif", lineHeight: "normal" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          <header style={{ width: "100%", height: 56, flexShrink: 0, padding: "0 18px", display: "flex", alignItems: "center", justifyContent: "space-between", background: panel }}>
            <strong style={{ fontSize: 24 }}>FIELD NOTES</strong>
            <span style={{ color: muted, fontSize: 16 }}>Aspect-ratio layout study</span>
          </header>
          ...
          <section style={{ width: "100%", display: "flex", alignItems: "flex-start", gap: 18 }}>
            <div style={{ minWidth: 0, flex: 1, display: "flex", flexDirection: "column", gap: 16 }}>
              <div style={{ position: "relative", width: "100%", height: "auto", aspectRatio: "4 / 1", padding: 24, background: "rgb(46,122,184)" }}>
                <div style={{ fontSize: 37, fontWeight: 700 }}>DESERT LIGHT</div>
                <div style={{ color: "rgb(209,230,250)", fontSize: 17 }}>A responsive hero whose height follows its final width.</div>
                <div style={{ position: "absolute", width: 164, height: "auto", aspectRatio: "2 / 1", right: 24, top: 24, padding: 12, background: "rgb(250,194,51)", color: "rgb(41,31,10)", fontWeight: 700, fontSize: 15 }}>
                  FEATURED
                </div>
              </div>
            ...
            <aside style={{ width: 300, flexShrink: 0, padding: 14, display: "flex", flexDirection: "column", gap: 14, background: panel }}>
              ...
              <strong style={{ fontSize: 19 }}>SPECIMEN 07</strong>
              <span style={{ color: muted, fontSize: 16 }}>The replaced image shares the same square presentation as the GUI reference.</span>
              <div style={{ width: "100%", height: "auto", aspectRatio: "3 / 1", padding: 12, background: "rgb(250,194,51)", color: "rgb(41,31,10)", fontWeight: 700, fontSize: 15 }}>
                VIEW COLLECTION
              </div>
            </aside>
          </section>
          ...
          <section style={{ width: "100%", height: "auto", maxHeight: 120, aspectRatio: "10 / 1", flexShrink: 0, padding: "0 22px", display: "flex", alignItems: "center", justifyContent: "space-between", background: "rgb(36,41,54)" }}>
            <strong style={{ fontSize: 19 }}>Build a collection around the dimensions that matter.</strong>
            <strong style={{ color: "rgb(250,194,51)", fontSize: 16 }}>EXPLORE →</strong>
          </section>

          <section style={{ position: "relative", width: "100%", height: 220, flexShrink: 0, padding: 22, background: panel }}>
            <strong style={{ fontSize: 19 }}>FLOATING EXHIBIT</strong>
            <div style={{ color: muted, fontSize: 16 }}>This inset-resolved card intentionally crosses the section boundary.</div>
            <div style={{ position: "absolute", left: 32, right: 160, top: 76, width: "auto", height: "auto", aspectRatio: "6 / 1", padding: 18, background: "rgb(245,77,117)" }}>
              ...
              <strong style={{ fontSize: 17 }}>OUT OF FLOW / IN PROPORTION</strong>
            </div>
          </section>

          <section style={{ width: "100%", height: 420, flexShrink: 0, padding: "180px 22px 0", background: "rgb(31,36,48)" }}>
            <strong style={{ fontSize: 20 }}>ARCHIVE</strong>
